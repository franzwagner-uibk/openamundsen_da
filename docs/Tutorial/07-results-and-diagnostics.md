...
For the shipped examples, a curated `project_maps.yml` now drives publication-style PNG exports under `results/maps/`. Use `oa-da-plot-project-maps --project-dir /data/rofental/projects/project_2022_2023` to rerender them directly from the compact summary grid.
