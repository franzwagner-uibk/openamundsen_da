...
openamundsen-da run /data/setup/projects/project_2022_2023 --max-workers 24
```
...
```bash
openamundsen-da render /data/setup/projects/project_2022_2023 --max-workers 24
```
...
docker run --rm \
  ...
  openamundsen-da run /data/projects/project_2022_2023 --max-workers 8
```
...
openamundsen-da subdomains run PROJECT_DIR --max-workers 8 --inner-max-workers 3
openamundsen-da subdomains merge PROJECT_DIR
openamundsen-da subdomains render PROJECT_DIR --max-workers 8
```
...
openamundsen-da subdomains model run SETUP_DIR --max-workers 24
