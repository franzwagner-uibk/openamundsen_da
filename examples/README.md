...
- The shipped `rofental` project uses the promoted tuned `project_2022_2023` baseline: seed `113`, five station snow-depth events, one spring `wet_snow_line` event, and four SCF events. It keeps `wet_snow_fraction` as a diagnostic benchmark in the wet-snow summary outputs.
